...
def singleMagnet(position, dipoleMoment, simDimensions, resolution):
    # Creates B0 for one magnet across the entire simulation Dimensions given (simDimensions)
    ...
    # TODO: Look into https://plotly.com/python/3d-mesh/ 
    # Maybe: https://stackoverflow.com/questions/68297161/creating-a-blender-mesh-directly-from-numpy-data
...
def createHalbach(numMagnets = 24, rings = (-0.075,-0.025, 0.025, 0.075), radius = 0.145, magnetSize = 0.0254, kValue = 2, resolution = 1000, bRem = 1.3, simDimensions = (0.3, 0.3, 0.2)):
    ...
    #Note simdimensions might need to change for different magnetArray sizes SDP
